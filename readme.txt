...
0. Highlight IP/URL in webpage and right click.
1. Select contextMenu "Run x-PLUG.bat"


What it does:

Runs x-PLUG.bat from C:\FFPLUGS\x-PLUG.bat with selected IP/URL as argument.